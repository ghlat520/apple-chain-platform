/**
 * apple-chain-platform Design Tokens — apple-admin-ui (PC Element Plus 端)
 *
 * ⚠️ 本文件由 DESIGN.md 派生，与 apple-web-ui/src/design/tokens.js 保持完全一致。
 *    禁止直接修改；任何修改先改 DESIGN.md，再同步 apple-web-ui 与本文件两份。
 *
 * 使用方式：
 *   import { tokens } from '@/design/tokens'
 *   <div :style="{ color: tokens.color.text.primary }" />
 *
 * 推荐：使用 CSS 变量（已注入 :root，见 element-theme.css）：
 *   <div style="color: var(--color-text-primary); background: var(--color-surface-raised)" />
 *
 * Element Plus 主题覆盖：
 *   见 src/design/element-theme.css（CSS 变量方式，无需 SCSS 编译）
 */
